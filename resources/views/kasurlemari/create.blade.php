              ...
              <div class="row">
                <div class="col-lg-12 mb-4 order-0">
                  <div class="card">
                      ...
                      <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data Pembayaran Kasur & lemari/</span> Tambah Data Pembayaran Kasur & Lemari</h4>
              ...
              <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                  <div class="card-body p-0">
                    <form action="{{ route('data-kl.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
