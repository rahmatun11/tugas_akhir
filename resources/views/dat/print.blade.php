...
<body>
  <div class="container">
    ...
    <h2>Struk Pembayaran DAT(Dana Akhir Tahun)</h2>
    ...
    <table>
      ...
      <tr>
        <td>Nama Siswa: </td>
        <td>{{$dat->siswa->nama}}</td>
      </tr>
      <tr>
        <td>Kelas:</td>
        <td>{{$dat->kelas->nama_kelas}}</td>
      </tr>
      <tr>
        <td>Tahun Ajaran:</td>
        <td>{{$dat->tahun_ajaran->tahun_ajaran}}</td>
      </tr>
      <tr>
    </table>
    ...
    <table>
      ...
      <tr>
        ...
        <td>{{$dat->tanggal_bayar}}</td>
      </tr>
      <tr class="total-row">
        <td>total:</td>
        <td>{{ 'Rp. ' . number_format($dat->jumlah_bayar, 0, ',', '.') }}</td>
      </tr>
    </table>
