                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                @if(isset($item->siswa) && isset($totals[$item->siswa->nisn]))
                                    <input type="text" class="form-control saldo-tabungan" value="{{ 'Rp ' . number_format($totals[$item->siswa->nisn], 0, ',', '.') }}" readonly>
                                @elseif(isset($item->siswa))
                                    Data kosong
                                @else
                        ...
                        <td>
                            @if(isset($item->siswa) && isset($item->siswa->nisn))
