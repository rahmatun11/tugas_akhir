        ...
        <div class="row">
            <div class="col-lg-12 mb-4 order-0">
                <div class="card">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data Pembayaran Spp/</span> Tambah
                            Data Pembayaran Spp</h4>
                        <div class="card">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <select name="nisn" id="nisn" class="form-control"
                                                        class="custom-select" {{ count($siswa) == 0 ? 'disabled' : '' }}>
                                                        @if (count($siswa) == 0)
                                                            <option value="">Pilihan tidak ada</option>
                                                        @else
                                                            <option value="">Silahkan pilih</option>
                                                            @foreach ($siswa as $sis)
                                                                <option value="{{ $sis->nisn }}">{{ $sis->nama }}
                                                                </option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="bulan_bayar" class="form-control"
                                                        value="{{ old('bulan_bayar') }}">
                                                    <br>
                                                </div>
                                                <div class="form-group">
                                                    <label for="">KELAS</label>
                                                    <select name="kelas" id="" class="form-control"
                                                        class="custom-select" {{ count($kelas) == 0 ? 'disabled' : '' }}>
                                                        @if (count($kelas) == 0)
                                                            <option value="">Pilihan tidak ada</option>
                                                        @else
                                                            <option value="">Silahkan pilih</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="spp" id="id_spp" class="form-control"
                                                        class="custom-select" {{ count($spp) == 0 ? 'disabled' : '' }}>
                                                        @if (count($spp) == 0)
                                                            <option value="">Pilihan tidak ada</option>
                                                        @else
                                                            <option value="">Silahkan pilih</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="jumlah_bayar" id="jumlah_bayar"
                                                        class="form-control" value="{{ $spp->first()->nominal }}">
                                                    <br>
                                                </div>
                                                <div class="form-group">
