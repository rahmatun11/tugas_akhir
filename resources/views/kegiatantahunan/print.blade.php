...
<body>
  <div class="container">
    ...
    <h2>Struk Pembayaran Kegiatan Tahunan</h2>
    ...
    <table>
      ...
      <tr>
        <td>Nama Siswa: </td>
        <td>{{$kegiatan_pertahun->siswa->nama}}</td>
      </tr>
      <tr>
        <td>Kelas:</td>
        <td>{{$kegiatan_pertahun->kelas->nama_kelas}}</td>
      </tr>
      <tr>
        <td>Tahun Ajaran:</td>
        <td>{{$kegiatan_pertahun->tahun_ajaran->tahun_ajaran}}</td>
      </tr>
      <tr>
    </table>
    ...
    <table>
      ...
      <tr>
        ...
        <td>{{$kegiatan_pertahun->tanggal_bayar}}</td>
      </tr>
      <tr class="total-row">
        <td>total:</td>
        <td>{{$kegiatan_pertahun->jumlah_bayar}}</td>
      </tr>
    </table>
