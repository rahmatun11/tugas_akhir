...
<body>
  <div class="container">
    ...
    <table>
      ...
      <tr>
        <td>Tahun Ajaran:</td>
        <td>{{$buku->tahun_ajaran->tahun_ajaran}}</td>
      </tr>
      <tr>
    </table>
    ...
    <table>
      ...
      <tr>
        ...
        <td>{{$buku->tanggal_bayar}}</td>
      </tr>
      <tr class="total-row">
        <td>total:</td>
        <td>{{ 'Rp. ' . number_format($buku->jumlah_bayar, 0, ',', '.') }}</td>
      </tr>
    </table>
