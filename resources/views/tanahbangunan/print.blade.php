...
<body>
  <div class="container">
    ...
    <h2>Struk Pembayaran KTanah & Bangunan</h2>
    ...
    <table>
      ...
      <tr>
        <td>Nama Siswa: </td>
        <td>{{$tanah_bangunan->siswa->nama}}</td>
      </tr>
      <tr>
        <td>Kelas:</td>
        <td>{{$tanah_bangunan->kelas->nama_kelas}}</td>
      </tr>
      <tr>
        <td>Tahun Ajaran:</td>
        <td>{{$tanah_bangunan->tahun_ajaran->tahun_ajaran}}</td>
      </tr>
      <tr>
    </table>
    ...
    <table>
      ...
      <tr>
        ...
        <td>{{$tanah_bangunan->tanggal_bayar}}</td>
      </tr>
      <tr class="total-row">
        <td>total:</td>
        <td>{{ 'Rp. ' . number_format($tanah_bangunan->jumlah_bayar, 0, ',', '.') }}</td>
      </tr>
    </table>
